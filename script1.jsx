/*this script is written for user made json files of a specific format which represents the template for a city.
The same method can used for other templates.*/
